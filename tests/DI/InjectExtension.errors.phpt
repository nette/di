...
services:
	service:
		...
		inject: yes
');
}, InvalidStateException::class, 'Service of type DateTimeImmutable used in type hint at ServiceA::$a not found.
...
services:
	service:
		...
		inject: yes
');
}, InvalidStateException::class, "Class or interface 'Unknown' used in type hint at ServiceB::\$a not found.
