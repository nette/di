...
Return type of Factory::createNullableClass() is expected to not be nullable/built-in/complex, '?stdClass' given.");
...
Return type of Factory::createUnion() is expected to not be nullable/built-in/complex, 'stdClass|array' given.");
