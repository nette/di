...
// only service of its type, but excluded from autowiring
...
// 'plain' is demoted by the autowiring preference for 'pref'
...
// 'pref' is demoted for stdClass (autowired only for Preferred)
